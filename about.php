  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        ...
        <p class="lead text-white">HDF often establish schools, educational programs, or scholarship opportunities to ensure that children and adults have access to quality education.</p>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <p> HDF often establish schools, educational programs, or scholarship opportunities to ensure that children and adults have access to quality education..</p>
            <p> HDF work to provide clean water sources, sanitation facilities, and hygiene education in areas lacking these essential resources..</p>
            <p> HDF play a crucial role in providing immediate aid and long-term support to communities affected by natural disasters or conflicts.</p>
    ...
    <div class="site-section">
      <div class="container">
            ...
            <div class="d-md-flex cta-20101 align-self-center bg-light p-5">
              ...
              <div class="ml-auto"><a href="index.php" class="btn btn-primary">Donate Now</a></div>
            </div>
